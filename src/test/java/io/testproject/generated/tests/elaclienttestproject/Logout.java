 ...
 * Generated on Mon Sep 27 04:39:42 GMT 2021.
 */
@DisplayName("Logout")
public class Logout implements ExceptionsReporter {
  ...
  void execute() throws Exception {
    ...
    */
    ...
    // 3. Click 'com.byjus.tle.staging:id/imgHamburger...'
    /* Step is disabled
    GeneratedUtils.sleep(500);
    by = By.id("com.byjus.tle.staging:id/imgHamburgerMenu");
    driver.findElement(by).click();
    */
    // 4. Click 'Logout1'
    GeneratedUtils.sleep(500);
    by = By.xpath("//android.widget.TextView[@text = 'Logout']");
    driver.findElement(by).click();

    // 5. Click 'Logout'
    GeneratedUtils.sleep(500);
    by = By.id("com.byjus.tle.staging:id/tvConfirmationPositveButton");
    driver.findElement(by).click();
