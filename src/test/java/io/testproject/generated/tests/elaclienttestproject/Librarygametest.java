 ...
 * Project: ELA
 * Test: Library_Game_Test
 * Generated by: ankur vishwakarma (ankur.vishwakarma@byjus.com)
 * Generated on Mon Sep 27 04:38:57 GMT 2021.
 */
@DisplayName("Library_Game_Test")
public class Librarygametest implements ExceptionsReporter {
  ...
  void execute() throws Exception {
    ...
    // 4. Is 'Games' present?
    GeneratedUtils.sleep(500);
    by = By.xpath("//android.widget.TextView[@text = 'Games']");
    ...
    // 6. Click 'com.byjus.tle.staging:id/libraryThumb...1'
    GeneratedUtils.sleep(500);
    by = By.xpath("//android.view.ViewGroup[2]/androidx.recyclerview.widget.RecyclerView[1]/android.view.ViewGroup[1]//android.widget.ImageView[1]");
    driver.findElement(by).click();

    // 7. Is 'Tap the types of trees' present?
    GeneratedUtils.sleep(500);
    by = By.xpath("//android.view.View[@text = 'Tap the types of trees']");
    driver.findElement(by);
